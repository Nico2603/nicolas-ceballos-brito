...
| Body | Plus Jakarta Sans | `font-sans` | 400, 500, 600, 700, 800 |

Autohospedadas con `@fontsource` en `src/index.css` (`font-display: swap`). No usar Google Fonts en `index.html`.
...
| Foto de perfil | `public/images/pic.webp` | 288×288 (Hero) | Variantes `pic-288.webp` / `pic-576.webp` generadas en prebuild; Hero usa `<img>` con `srcSet` (elemento LCP) |
